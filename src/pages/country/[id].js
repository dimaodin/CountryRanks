            ...
            <div className={styles.container}>
                ...
                <div className={styles.container_right}>
                    <div className={styles.detail_panel}>
                        ...
                        <div className={styles.detail_panel_row}>
                            <div className={styles.detail_panel_label}>Currency:</div>
                            <div className={styles.detail_panel_value}>
                        ...
                        <div className={styles.detail_panel_borders}>
                            ...
                            <div className={styles.detail_panel_border_container}>
                               
                                {borders.map(({flag, name})=>(
                                            <div className={styles.detail_panel_border_country} key={name}>
                                                <img src={flag} alt={name} />

                                                <div className={styles.detail_panel_border_name}>{name}</div>
                                            </div>
                                        ))}
                            </div>  
                        </div>
